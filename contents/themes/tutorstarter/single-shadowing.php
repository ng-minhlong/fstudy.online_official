...
$sql_test = "SELECT type_test, testname, transcript FROM shadowing_question WHERE id_test = ?";
...
// Split the comma-separated string into an array
    ...
    <div id="tips-container">
        <div id="full-test-content">
            ...
            <a class="btn-submit" href="<?php echo $site_url?>/practice/shadowing/<?php echo $custom_number?>/start/" >Bắt đầu bài thi</a>
        </div>
        ...
        <div id="practice-content" style="display: none;">
            ...
            <form action="<?php echo $site_url?>/practice/shadowing/<?php echo $custom_number?>/start/"  method="get">
