...
<span style="display: inline-flex; align-items: center;">
    ...
    <input class="form-control answer-input" 
           ...
           autocomplete="off" />
    <img style="display:none; margin-left: 10px; cursor: pointer;" 
         id="bookmark-question-${completionNumber}" 
         src="" 
         class="bookmark-btn" 
            ...
            questionElement.innerHTML = `${questionContent}`;
                ...
                question.box_answers.forEach((boxAnswer, boxIndex) => {
                    ...
                    <div style="display: inline-flex; align-items: center;">
                        <span id = "mark-question-${completionNumber}" class = "number-question"> <p type = "${questionType}" style="margin: 0;"> <b >${completionNumber}</b> </p> </span> <input class="form-control" name = "question-id-${completionNumber}"  type="text" id="answer-input-${completionNumber}" class="answer-input" name="question-${completionNumber}"autocomplete="off" />
