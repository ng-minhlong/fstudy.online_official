    ...
    part: [
        {
            ...
            group_question: [ 
                ...
                {
                    "group": "1-10",
                    "question_group_content": "<p><em>Complete the form below.</em><br> <em>Write&nbsp;<strong>NO MORE THAN TWO WORDS AND/OR A NUMBER</strong>&nbsp;for each answer.</em></p>",
                    "type_group_question": "completion",
                    "add_side":"no",
                    "questions": [
                    {
                        "question": "<p><strong>SHORT STAY ACCOMMODATION</strong></p> <p><strong>Family Name:</strong>&nbsp;Mackinlay<br> <strong>First Name:</strong>&nbsp; <input> <br> <strong>Country of Origin:</strong>&nbsp;<input><br> <strong>Date of Arrival:</strong>&nbsp;<input><br> <strong>Number of Tenants:</strong>&nbsp; <input> <br> <strong>Length of Stay:</strong>&nbsp;2 weeks<br> <strong>Purpose of Visit:</strong>&nbsp; <input> <br> <strong>Type of Accommodation:</strong>&nbsp; <input> <br> <strong>Number of Bedrooms:</strong>&nbsp;one or two<br> <strong>Car Parking:</strong>&nbsp;off-street and&nbsp; <input> <br> <strong>General Area:</strong>&nbsp;near the beach<br> <strong>Other Requirements:</strong>&nbsp;near&nbsp; <input> <br> <strong>Name of Town:</strong>&nbsp; <input> <br> <strong>Client's Email:</strong>&nbsp;smac13@hotmail.com<br> <strong>Price Range:</strong>&nbsp;up to $&nbsp; <input> &nbsp;a week</p></div>",
                        "box_answers": [
        ...
        },
        {
            ...
            group_question: [
                {
                    "group": "11-14",
                    "question_group_content": "Choose the correct letter, A, B or C.",
                    "type_group_question": "multiple-choice",
                    "add_side":"no",
                    "questions": [
                    {
                        "question": "Refreshments will be served",
                        "answers": [
                        ["A. at the front counter.", true],
                        ["B. in the lobby.", false],
                        ["C. at the back of the hall.", false]
                        ]
                    },
                    {
                        "question": "Nick Noble advertised",
                        "answers": [
                        ["A. on the radio.", true],
                        ["B. on a billboard.", false],
                        ["C. in the newspaper.", false]
                        ]
                    },
                    {
                        "question": "The original number of founding members was about",
                        "answers": [
                        ["A. 12.", true],
                        ["B. 20.", false],
                        ["C. 200.", false]              
                    ...
                    {
                        "question": "The club provides activities primarily for reasonably fit",
                        "answers": [
                        ["A. males up to 75.", true],
                        ["B. females with young children.", false],
                        ["C. males and females of any age.", false]
                        ]
                    }
                ...
                {
                    "group": "15-20",
                    "question_group_content": "<p><em>Complete the table below.</em><br><em>Write&nbsp;<strong>NO MORE THAN ONE WORD AND/OR A NUMBER</strong>&nbsp;for each answer.</em></p>",
                    "type_group_question": "completion",
                    "add_side":"no",
                    "questions": [
                    {
                        "question": "<table> <tbody> <tr> <td colspan='11'>Activity</td> <td colspan='20'>Day(s)</td> <td colspan='10'>Duration</td> <td colspan='20'>Contact person</td> </tr> <tr> <td colspan='11'> <input> </td> <td colspan='20'>Tuesday &amp; Saturday</td> <td colspan='10'>about 3-5 hours</td> <td colspan='20'>coordinator</td> </tr> <tr> <td colspan='11'> <input> </td> <td colspan='20'>Thursday &amp; Sunday</td> <td colspan='10'>up to 3 hours</td> <td colspan='20'> <input> </td> </tr> <tr> <td colspan='11'>Wanderers</td> <td colspan='20'>Sunday</td> <td colspan='10'> <input> </td> <td colspan='20'>leader</td> </tr> <tr> <td colspan='11'> <input> <br> Weekends</td> <td colspan='20'>Saturday &amp; Sunday</td> <td colspan='10'>all weekend</td> <td colspan='20'> <input> </td> </tr> </tbody> </table>",
                        "box_answers": [
                        { "answer": "Answer for element called 7" },
                        { "answer": "Answer for mineral 8" },
        ...
        },
        {
            ...
            group_question: [
                {
                    "group": "21-26",
                    "question_group_content": "<p><em>Complete the notes below.</em><br> <em>Write&nbsp;<strong>NO MORE THAN TWO WORDS</strong>&nbsp;for each answer.</em></p>",
                    "type_group_question": "completion",
                    "add_side":"no",
                    "questions": [
                    {
                        "question": "<p><strong>'Globalisation and Educational Change'</strong></p> <p>●&nbsp;<del>GEC 692</del>&nbsp;New Code:&nbsp;<input><br> ● Aims—Analysis of educational problems arising from globalisation<br> ● Chance to research and&nbsp;<input>&nbsp;progress of educational change<br> ● Investigate influence of culture and&nbsp;<input>&nbsp;on education<br> ● Argue advantages and disadvantages of reorganisation of public education in own country with regard to globalisation<br> ● Consider the&nbsp;<input>&nbsp;of globalisation on diversity of national curricula across richer and poorer countries<br> ● Assignment # 1 = power point presentation (ungraded) +&nbsp; <input> &nbsp;(30%)<br> ● Assignment # 2 = take part in&nbsp; <input> &nbsp;(20%) + essay (50%)</p>",
                        "box_answers": [
                        { "answer": "Answer for element called 7" },
                        { "answer": "Answer for mineral 8" },
                        { "answer": "Answer for element 9" },
                ...
                {
                    "group": "27-30",
                    "question_group_content": "<p><em>Complete the table below.</em><br><em>Write&nbsp;<strong>NO MORE THAN TWO WORDS AND/OR A NUMBER</strong>&nbsp;for each answer.</em></p>",
                    "type_group_question": "completion",
                    "add_side":"no",
                    "questions": [
                    {
                        "question": "<table> <tbody> <tr> <td colspan='9'>Author</td> <td colspan='22'>Title</td> <td colspan='11'>Date</td> </tr> <tr> <td colspan='9'> <input> </td> <td colspan='22'>Comparative Education</td> <td colspan='11'>2007</td> </tr> <tr> <td colspan='9'>Elliot</td> <td colspan='22'>Educational Issues of the New Millennium</td> <td colspan='11'> <input>  </td> </tr> <tr> <td colspan='9'><input>  </td> <td colspan='22'>Education and Globalisation</td> <td colspan='11'>2009</td> </tr> <tr> <td colspan='9'>York</td> <td colspan='22'>Globalisation and <input> </td> <td colspan='11'>2010</td> </tr> </tbody> </table>",
                        "box_answers": [
                        { "answer": "Answer for element called 7" },
                        { "answer": "Answer for mineral 8" },
                        { "answer": "Answer for element 9" },
...

        {
            ...
            group_question: [
                {
                    "group": "31-37",
                    "question_group_content": "<em>Complete the summary below.</em><br> <em>Write&nbsp;<strong>NO MORE THAN TWO WORDS</strong>&nbsp;for each answer.</em>",
                    "type_group_question": "completion",
                    "add_side":"no",
                    "questions": [
                    {
                        "question": "<p> Every day the human body is fighting off&nbsp;<input> &nbsp;by destructive pathogens. A person in good health has natural protection in the form of an immune system which works best against familiar microorganisms which may have been encountered during a previous&nbsp;<input> &nbsp;or passed on by the mother before or after birth.<br> Vaccination is a way to cause&nbsp;<input> &nbsp;immunisation by introducing a small amount of pathogen into the body—just enough for the body's&nbsp;<input> &nbsp;to react by making antibodies. Passive immnnisation can be used as a way of treating someone who is already sick. Proteins from animal&nbsp;<input> &nbsp;are introduced into the patient to give him the necessary antibodies to fight the disease.<br> Dr. Edward Jenner observed that people who had suffered and recovered from a serious disease called smallpox did not get it again. He also noted that victims of a milder disease, cowpox, which they caught from&nbsp;<input> &nbsp;, were immune to smallpox. He carried out a successful&nbsp;<input> &nbsp;by deliberately giving a child cowpox in order to make him immune to smallpox.</p>",
                        "box_answers": [
                        { "answer": "Answer for element called 7" },
                        { "answer": "Answer for mineral 8" },
                        { "answer": "Answer for element 9" },
...

                {
                    ...
                    "image":"https://maythongdich.com/upload/phan-mem-chat-tieng-anh-voi-robot/phan-mem-luyen-noi-tieng-anh-voi-nguoi-ao-a-bot.jpg",
    ...
    part.group_question.forEach((group, groupIndex) => {
        ...
        group.questions.forEach((question, questionIndex) => {
            ...
            if (group.type_group_question === "multi-select") {
                ...
                questionElement.innerHTML = `<span id = "mark-question-${currentQuestionNumber}" class = "number-question"> <p  name = "question-id-${currentQuestionNumber}"  id ="question-id-${questionRange}"> <b>${questionRange}.</b> </p> </span>  <p> ${question.question}</p> <br> ${image}`;
           ...
           if (group.type_group_question === "completion") {
            ...
            if(group.add_side == "no"){
                ...
                question.box_answers.forEach((boxAnswer, boxIndex) => {
                    ...
                    <div style="display: inline-flex; align-items: center;">
                        <span id = "mark-question-${completionNumber}" class = "number-question"> <p type = "${questionType}" style="margin: 0;"> <b >${completionNumber}</b> </p> </span> <input class="form-control" name = "question-id-${completionNumber}"  type="text" id="answer-input-${completionNumber}" class="answer-input" name="question-${completionNumber}" />
            ...
            questionElement.innerHTML = `<p>${questionContent}</p>`;
            ...
            else if (group.add_side === "yes" && group.add_side_order.left === "image") {
                // Thay thế <input> trước
                question.box_answers.forEach((boxAnswer, boxIndex) => {
                    const completionNumber = currentQuestionNumber + boxIndex;
                    const questionType = part.question_types?.[completionNumber] || "";
                ...
                const imageHtml = `
                    <div style="width: 50%; float: left;">
                        <img src="${group.image}" alt="Question Image" style="max-width: 100%; height: auto;">
                    </div>`;
                const questionHtml = `
                ...
                questionElement.innerHTML = `<div style="display: flex;">${imageHtml}${questionHtml}</div>`;
            }
            else if (group.add_side === "yes" && group.add_side_order.left === "question_group_content") {
                groupContainer.innerHTML = `
                    <h4>Question ${group.group}:</h4>
                `;
                // Thay thế <input> trước
...
async function submitAnswerAndGenerateLink() {
    try {
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                window.location.href = `${siteUrl}/ielts/l/result/${resultId}`;
            }
        });
    } catch (error) {
...
jQuery('#saveListeningResult').submit();
    ...
    jQuery.ajax({
        ...
        data: {
           ...
           // username: change_content,
            time_left: time_left,
            id_test: id_test,
            table_test: 'ielts_listening_test_list',
