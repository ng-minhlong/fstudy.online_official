...
$new_skip_ans = 0;
    ...
    foreach ($results as $result) {
        ...
        $incorrectOrSkippedQuestions = []; // Declare the PHP array
        ...
        if (empty($incorrectOrSkippedQuestions)) {
            echo "You don\\'t have any error answer to do test";
            exit;
        }
        else{
            echo "<script>";
            ...
            <div class="main-block" >
                <div id = "test-prepare">
                    ...
                    <div id = "checkpoint" class = "checkpoint">
                       <i style = "color: red">Đây là phần luyện tập các câu đã trả lời sai !</i>
                    </div>
         ...
         <!-- end note sidebar -->
                  ...
                  <div id="time-remaining-container"  >
                    ...
                    <div class = "fixedleftsmallbuttoncontainer" style="display: none;">
                                <button  class ="buttonsidebar" onClick="reloadTest()"><img width="25px"  src="<?php echo $site_url; ?>/contents/themes/tutorstarter/system-test-toolkit/reload.png" ></button><br>
...
function convertImageTag(text) {
    return text.replace(/([a-zA-Z0-9_-]+\.png)/g, function(match) {
        return '<img class="img-ans" src="/contents/themes/tutorstarter/template/media_img_intest/digital_sat/' + match + '" />';
    });
}
...
function main() {
   ...
   MathJax.Hub.Queue(["Typeset",MathJax.Hub]);
    ...
    Promise.all(encodingPromises).then(() => {
        ...
        contentQuestions +=`   <div class="navigation-group"> <div class="left-group"><p id="current_module" style="display: none;"></p></div>`;
...
<!-- script type="text/javascript" src="'. $site_url .'/contents/themes/tutorstarter/system-test-toolkit/function_practice/main_sat_10.js"></script> -->

<script type="text/javascript" src="'. $site_url .'/contents/themes/tutorstarter/system-test-toolkit/function_practice/translate.js"></script>
<script type="text/javascript" src="'. $site_url .'/contents/themes/tutorstarter/system-test-toolkit/function_practice/zoom-text.js"></script>

<!--<script type="text/javascript" src="'. $site_url .'/contents/themes/tutorstarter/system-test-toolkit/function_practice/toggle-time-remaining-container.js"></script>-->
...
<script type="text/javascript" src="'. $site_url .'/contents/themes/tutorstarter/system-test-toolkit/function_practice/fullscreen.js"></script>
<script type="text/javascript" src="'. $site_url .'/contents/themes/tutorstarter/system-test-toolkit/function_practice/format-time-1.js"></script>
<script type="text/javascript" src="'. $site_url .'/contents/themes/tutorstarter/system-test-toolkit/function_practice/draft-popup.js"></script>
<script type="text/javascript" src="'. $site_url .'/contents/themes/tutorstarter/system-test-toolkit/function_practice/color-background.js"></script>
<script type="text/javascript" src="'. $site_url .'/contents/themes/tutorstarter/system-test-toolkit/function_practice/start-digital-sat-Test-2.js"></script>
<!-- <script type="text/javascript" src="function_practice/quick-view-answer.js"></script> -->
<script type="text/javascript" src="'. $site_url .'/contents/themes/tutorstarter/system-test-toolkit/function_practice/checkbox_and_remember_2.js"></script>

<script type="text/javascript" src="'. $site_url .'/contents/themes/tutorstarter/system-test-toolkit/function_practice/reload-test.js"></script>
<script type ="text/javascript" src="'. $site_url .'/contents/themes/tutorstarter/system-test-toolkit/function_practice/change-mode.js"></script> 
<!--
<script type ="text/javascript" src="'. $site_url .'/contents/themes/tutorstarter/system-test-toolkit/function_practice/disable-view-inspect.js"></script> -->

<script type="text/javascript" src="'. $site_url .'/contents/themes/tutorstarter/system-test-toolkit/function_practice/print-exam.js"></script>
