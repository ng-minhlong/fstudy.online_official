...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $row = $wpdb->get_row($wpdb->prepare("SELECT * FROM ielts_speaking_part_3_question WHERE number = %d", $number), ARRAY_A);
...
?>
        <form method="post" action="update_question.php">
            ...
            STT: <input type="number" name="stt" value="<?php echo esc_attr($row['stt']); ?>" required><br>
