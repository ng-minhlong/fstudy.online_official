<?php
/*
 * Template Name: Test LIST Ielts Speaking
 */
$servername = DB_HOST;
 $username = DB_USER;
...
$total_sql = "SELECT COUNT(*) FROM ielts_speaking_test_list";
if ($id_test_filter) {
...
$sql = "SELECT * FROM ielts_speaking_test_list";
if ($id_test_filter) {
...
<head>
    <meta charset="UTF-8">
    <title>List các đề Ielts Speaking Test</title>
...
<h1>List các đề Ielts Speaking Test</h1>
