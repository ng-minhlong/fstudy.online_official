...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    $row = $wpdb->get_row($wpdb->prepare("SELECT * FROM ielts_writing_task_1_question WHERE number = %d", $number), ARRAY_A);
...
?>
        <form method="post" action="update_question.php">
            ...
            Image Link: <input  type="text" name="image_link" value="<?php echo esc_attr($row['image_link']); ?>" required><br>
