...
async function openPreviewModal(idPart) {
    ...
    try {
        ...
        const response = await fetch(`http://localhost/contents/themes/tutorstarter/template/ielts/ieltsreadingtest/reading-part-2-database-template/get_question_data.php?id_part=${idPart}`);
...
function openEditModal(number) {
    $.ajax({
        url: 'http://localhost/contents/themes/tutorstarter/template/ielts/ieltsreadingtest/reading-part-2-database-template/get_question.php', // Fetch the question details
        type: 'POST',
        data: { number: number },
...
function saveEdit() {
    ...
    $.ajax({
        url: 'http://localhost/contents/themes/tutorstarter/template/ielts/ieltsreadingtest/reading-part-2-database-template/update_question.php',
        type: 'POST',
        data: formData,
...
function saveNew() {
    ...
    $.ajax({
        url: 'http://localhost/contents/themes/tutorstarter/template/ielts/ieltsreadingtest/reading-part-2-database-template/add_question.php',
        type: 'POST',
        data: formData,
        processData: false, // Required for FormData
        contentType: false, // Required for FormData
...
function deleteRecord(number) {
    if (confirm('Are you sure you want to delete this question?')) {
        $.ajax({
            url: 'http://localhost/contents/themes/tutorstarter/template/ieltsreadingtest/reading-part-2-database-template/delete_question.php',
            type: 'POST',
            data: { number: number },
            success: function(response) {
