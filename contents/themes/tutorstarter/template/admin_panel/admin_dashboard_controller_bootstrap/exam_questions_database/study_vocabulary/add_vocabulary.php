...
function openEditModal(number) {
    $.ajax({
        url: '<?php echo get_site_url()?>/contents/themes/tutorstarter/template/studyvocabulary/study-vocabulary-database-template/get_question.php', // Fetch the question details
        type: 'POST',
        data: { number: number },
...
function openAddModal() {
    ...
    $.ajax({
        url: '<?php echo get_site_url()?>/contents/themes/tutorstarter/template/studyvocabulary/study-vocabulary-database-template/get_latest_id.php',
        type: 'GET',
        success: function(response) {
            $('#add_id').val(response);
        }
...
function saveEdit() {
    ...
    $.ajax({
        url: '<?php echo get_site_url()?>/contents/themes/tutorstarter/template/studyvocabulary/study-vocabulary-database-template/update_question.php',
        type: 'POST',
...
function saveNew() {
    ...
    $.ajax({
        url: '<?php echo get_site_url()?>/contents/themes/tutorstarter/template/studyvocabulary/study-vocabulary-database-template/add_question.php',
        type: 'POST',
...
function deleteRecord(number) {
    if (confirm('Are you sure you want to delete this vocabulary?')) {
        $.ajax({
            url: '<?php echo get_site_url()?>/contents/themes/tutorstarter/template/studyvocabulary/study-vocabulary-database-template/delete_question.php',
            type: 'POST',
            data: { number: number },
            success: function(response) {
