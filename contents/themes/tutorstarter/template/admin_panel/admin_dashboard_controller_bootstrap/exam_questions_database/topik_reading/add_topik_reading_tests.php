...
function openEditModal(number) {
    $.ajax({
        url: 'http://localhost/contents/themes/tutorstarter/template/topik/topik_reading/test-list/get_question.php', // Fetch the question details
        type: 'POST',
        data: { number: number },
...
function saveEdit() {
    $.ajax({
        url: 'http://localhost/contents/themes/tutorstarter/template/topik/topik_reading/test-list/update_question.php',
        type: 'POST',
...
function saveNew() {
    $.ajax({
        url: 'http://localhost/contents/themes/tutorstarter/template/topik/topik_reading/test-list/add_question.php',
        type: 'POST',
...
function deleteRecord(number) {
    if (confirm('Are you sure you want to delete this test ?')) {
        $.ajax({
            url: 'http://localhost/contents/themes/tutorstarter/template/topik/topik_reading/test-list/delete_question.php',
            type: 'POST',
            data: { number: number },
            success: function(response) {
