...
function openEditModal(number) {
    $.ajax({
        url: '<?php echo get_site_url()?>/contents/themes/tutorstarter/template/digitalsat/test-list/get_question.php', // Fetch the question details
        type: 'POST',
        data: { number: number },
...
function saveEdit() {
    ...
    $.ajax({
        url: '<?php echo get_site_url()?>/contents/themes/tutorstarter/template/digitalsat/test-list/update_question.php',
        type: 'POST',
...
function saveNew() {
    ...
    $.ajax({
        url: '<?php echo get_site_url()?>/contents/themes/tutorstarter/template/digitalsat/test-list/add_question.php',
        type: 'POST',
...
function deleteRecord(number) {
    if (confirm('Are you sure you want to delete this question?')) {
        $.ajax({
            url: '<?php echo get_site_url()?>/contents/themes/tutorstarter/template/digitalsat/test-list/delete_question.php',
            type: 'POST',
            data: { number: number },
            success: function(response) {
