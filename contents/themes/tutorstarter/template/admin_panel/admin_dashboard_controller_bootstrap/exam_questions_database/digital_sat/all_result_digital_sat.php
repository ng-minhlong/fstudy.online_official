...
$total_sql = "SELECT COUNT(*) FROM save_user_result_digital_sat";
if ($idtest_filter) {
...
$sql = "SELECT * FROM save_user_result_digital_sat";
if ($idtest_filter) {
...
$sql2 = "SELECT * FROM digital_sat_test_list";
...
<head>
    ...
    <meta charset="UTF-8">
    <title>All Digital SAT Results</title>
    ...
    <?php include('../../sidebar.php'); ?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <?php include('../../topbar.php'); ?>
                ...
                <h1>All Digital SAT Results</h1>

<!-- Filter form -->
<form method="GET" action="">
    <input type="hidden" name="tab" value="<?php echo isset($_GET['tab']) ? $_GET['tab'] : 'full-test'; ?>">
    <div class="mb-3">
        <label for="idtest_filter" class="form-label">Filter by ID Test:</label>
        <input type="text" name="idtest_filter" id="idtest_filter" class="form-control" value="<?php echo $idtest_filter; ?>">
    </div>
...
<div class="container mt-4">
        ...
        <ul class="nav nav-tabs" id="testTabs" role="tablist">
            <li class="nav-item" role="presentation">
                <a class="nav-link <?php echo (!isset($_GET['tab']) || $_GET['tab'] === 'full-test') ? 'active' : ''; ?>" id="full-test-tab" href="?tab=full-test&page=<?php echo $page; ?>&idtest_filter=<?php echo $idtest_filter; ?>">Full Test</a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link <?php echo (isset($_GET['tab']) && $_GET['tab'] === 'practice') ? 'active' : ''; ?>" id="practice-tab" href="?tab=practice&page=<?php echo $page; ?>&idtest_filter=<?php echo $idtest_filter; ?>">Practice</a>
            </li>
            <li class="nav-item" role="presentation">
                <a class="nav-link <?php echo (isset($_GET['tab']) && $_GET['tab'] === 'quick-stats') ? 'active' : ''; ?>" id="quick-stats-tab" href="?tab=quick-stats&page=<?php echo $page; ?>&idtest_filter=<?php echo $idtest_filter; ?>">Quick Stats</a>
            </li>
        </ul>
        ...
        <div class="tab-content" id="testTabContent">
            <!-- Full Test Tab -->
            <div class="tab-pane fade <?php echo (!isset($_GET['tab']) || $_GET['tab'] === 'full-test') ? 'show active' : ''; ?>" id="fullTest" role="tabpanel" aria-labelledby="full-test-tab">
            ...
            <!-- Practice Tab -->
            <div class="tab-pane fade <?php echo (isset($_GET['tab']) && $_GET['tab'] === 'practice') ? 'show active' : ''; ?>" id="practice" role="tabpanel" aria-labelledby="practice-tab">
            <table class="table table-bordered mt-3">
            ...
            <!-- Any Content Tab -->
            <div class="tab-pane fade <?php echo (isset($_GET['tab']) && $_GET['tab'] === 'quick-stats') ? 'show active' : ''; ?>" id="quickStats" role="tabpanel" aria-labelledby="quick-stats-tab">
            <table class="table table-bordered mt-3">
        ...
        if ($result_tests->num_rows > 0) {
            ...
            while ($row = $result_tests->fetch_assoc()) {
                ...
                $stats_sql = "SELECT 
                                ...
                                COUNT(*) AS test_times 
                              FROM save_user_result_digital_sat 
  ...
  <nav aria-label="Page navigation">
    <ul class="pagination justify-content-center">
        <?php if ($page > 1): ?>
            <li class="page-item"><a class="page-link" href="?page=<?php echo $page - 1; ?>&idtest_filter=<?php echo $idtest_filter; ?>&tab=<?php echo isset($_GET['tab']) ? $_GET['tab'] : 'full-test'; ?>">Previous</a></li>
        <?php endif; ?>

        <?php for ($i = 1; $i <= $total_pages; $i++): ?>
            <li class="page-item <?php if ($i == $page) echo 'active'; ?>">
                <a class="page-link" href="?page=<?php echo $i; ?>&idtest_filter=<?php echo $idtest_filter; ?>&tab=<?php echo isset($_GET['tab']) ? $_GET['tab'] : 'full-test'; ?>"><?php echo $i; ?></a>
            </li>
        <?php endfor; ?>

        <?php if ($page < $total_pages): ?>
            <li class="page-item"><a class="page-link" href="?page=<?php echo $page + 1; ?>&idtest_filter=<?php echo $idtest_filter; ?>&tab=<?php echo isset($_GET['tab']) ? $_GET['tab'] : 'full-test'; ?>">Next</a></li>
        <?php endif; ?>
    </ul>
</nav>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="editForm">
                    ...
                    Overall Band: <input type="text" id="edit_resulttest" name="resulttest" class="form-control" required><br>
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addForm">
                    ...
                    Overall Band: <input type="text" id="add_resulttest" name="resulttest" class="form-control" required><br>
...
function openEditModal(number) {
    $.ajax({
        url: 'http://localhost/wordpress/contents/themes/tutorstarter/template/admin_panel/result_admin_page/digital_sat_results/get_result.php', // Fetch the question details
        type: 'POST',
        data: { number: number },
