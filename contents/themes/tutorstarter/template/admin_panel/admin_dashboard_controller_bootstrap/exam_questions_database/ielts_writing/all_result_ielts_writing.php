...
function openEditModal(number) {
    $.ajax({
        url: '<?php echo get_site_url()?>/contents/themes/tutorstarter/template/admin_panel/result_admin_page/ielts_writing_results/get_result.php', // Fetch the question details
        type: 'POST',
        data: { number: number },
...
function saveEdit() {
    $.ajax({
        url: '<?php echo get_site_url()?>/contents/themes/tutorstarter/template/admin_panel/result_admin_page/ielts_writing_results/update_result.php',
        type: 'POST',
...
function openDetailsModal(idTest) {
    $.ajax({
        url: '<?php echo get_site_url()?>/contents/themes/tutorstarter/template/admin_panel/result_admin_page/ielts_writing_results/get_test_details.php',
        method: 'POST',
        data: { id_test: idTest },
        success: function(response) {
            // Đổ dữ liệu vào bảng
...
function saveNew() {
    $.ajax({
        url: '<?php echo get_site_url()?>/contents/themes/tutorstarter/template/admin_panel/result_admin_page/ielts_writing_results/add_result.php',
        type: 'POST',
...
function deleteRecord(number) {
    if (confirm('Are you sure you want to delete this result?')) {
        $.ajax({
            url: '<?php echo get_site_url()?>/contents/themes/tutorstarter/template/admin_panel/result_admin_page/ielts_writing_results/delete_result.php',
            type: 'POST',
            data: { number: number },
            success: function(response) {
