<?php
/*
 * Template Name: Ielts Writing Task 1 Question DATABASE
 */
            ...
            <div class="modal-body">
                <form id="editForm">
                    ...
                    <select id="edit_question_type" name="question_type" class="form-control" required>
                        ...
                        <option value="Process">Process</option>Mixed graph
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="addForm">
                    ...
                    Task: <input type="number" id="add_task" name="task" class="form-control" value="1" readonly required><br>
                    Question Type: 
                    ...
                    Time: <input  id="add_time" name="time" class="form-control"  value="20" readonly required><br>
