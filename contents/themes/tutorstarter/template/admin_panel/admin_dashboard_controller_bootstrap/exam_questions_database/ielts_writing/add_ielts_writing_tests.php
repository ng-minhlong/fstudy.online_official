...
function openEditModal(number) {
    $.ajax({
        url: 'http://localhost/contents/themes/tutorstarter/template/ielts/ieltswritingtest/test-list/get_question.php', // Fetch the question details
        type: 'POST',
        data: { number: number },
...
function saveEdit() {
    $.ajax({
        url: 'http://localhost/contents/themes/tutorstarter/template/ielts/ieltswritingtest/test-list/update_question.php',
        type: 'POST',
...
function saveNew() {
    $.ajax({
        url: 'http://localhost/contents/themes/tutorstarter/template/ielts/ieltswritingtest/test-list/add_question.php',
        type: 'POST',
...
function deleteRecord(number) {
    if (confirm('Are you sure you want to delete this question?')) {
        $.ajax({
            url: 'http://localhost/contents/themes/tutorstarter/template/ielts/ieltswritingtest/test-list/delete_question.php',
            type: 'POST',
            data: { number: number },
            success: function(response) {
