<?php
/*
 * Template Name: Test LIST Ielts Writing
 */
...
$total_sql = "SELECT COUNT(*) FROM ielts_writing_test_list";
if ($id_test_filter) {
...
$sql = "SELECT * FROM ielts_writing_test_list";
if ($id_test_filter) {
...
<head>
    ...
    <meta charset="UTF-8">
    <title>List các đề Ielts Writing Test</title>
    ...
    <?php include('../../sidebar.php'); ?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <?php include('../../topbar.php'); ?>
                ...
                <h1>List các đề Ielts Writing Test</h1>
            ...
            while($row = $result->fetch_assoc()) {
                ...
                echo "<tr id='row_{$row['number']}'>
                        ...
                        <td>
                                ...
                                <a href='http://localhost/test/ielts/w/{$row['id_test']}' target='_blank'> {$row['id_test']}</a> 
                        ...
                        foreach ($questions as $index => $question) {
                            ...
                            echo "<a href = 'http://localhost/contents/themes/tutorstarter/template/admin_panel/admin_dashboard_controller_bootstrap/exam_questions_database/ielts_writing/add_ielts_writing_task_$templatePart.php?id_test_filter=$question' target='_blank'>$question</a>";
...
function openEditModal(number) {
    $.ajax({
        url: '<?php echo get_site_url()?>/contents/themes/tutorstarter/template/ielts/ieltswritingtest/test-list/get_question.php', // Fetch the question details
        type: 'POST',
        data: { number: number },
...
function saveEdit() {
    $.ajax({
        url: '<?php echo get_site_url()?>/contents/themes/tutorstarter/template/ielts/ieltswritingtest/test-list/update_question.php',
        type: 'POST',
...
function saveNew() {
    $.ajax({
        url: '<?php echo get_site_url()?>/contents/themes/tutorstarter/template/ielts/ieltswritingtest/test-list/add_question.php',
        type: 'POST',
...
function deleteRecord(number) {
    if (confirm('Are you sure you want to delete this question?')) {
        $.ajax({
            url: '<?php echo get_site_url()?>/contents/themes/tutorstarter/template/ielts/ieltswritingtest/test-list/delete_question.php',
            type: 'POST',
            data: { number: number },
            success: function(response) {
