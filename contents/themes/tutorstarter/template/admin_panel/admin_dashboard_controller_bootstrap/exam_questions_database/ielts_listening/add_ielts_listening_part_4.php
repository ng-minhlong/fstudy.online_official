...
async function openPreviewModal(idPart) {
    ...
    try {
        ...
        const response = await fetch(`<?php echo get_site_url()?>/contents/themes/tutorstarter/template/ielts/ieltslisteningtest/database-listening-part-4/get_question_data.php?id_part=${idPart}`);
...
function openEditModal(number) {
    $.ajax({
        url: '<?php echo get_site_url()?>/contents/themes/tutorstarter/template/ielts/ieltslisteningtest/database-listening-part-4/get_question.php', // Fetch the question details
        type: 'POST',
        data: { number: number },
...
function saveEdit() {
    ...
    $.ajax({
        url: '<?php echo get_site_url()?>/contents/themes/tutorstarter/template/ielts/ieltslisteningtest/database-listening-part-4/update_question.php',
        type: 'POST',
        data: formData,
...
function saveNew() {
    ...
    $.ajax({
        url: '<?php echo get_site_url()?>/contents/themes/tutorstarter/template/ielts/ieltslisteningtest/database-listening-part-4/add_question.php',
        type: 'POST',
        data: formData,
        processData: false, // Required for FormData
        contentType: false, // Required for FormData
...
function deleteRecord(number) {
    if (confirm('Are you sure you want to delete this question?')) {
        $.ajax({
            url: '<?php echo get_site_url()?>/contents/themes/tutorstarter/template/ielts/ieltslisteningtest/database-listening-part-4/delete_question.php',
            type: 'POST',
            data: { number: number },
            success: function(response) {
