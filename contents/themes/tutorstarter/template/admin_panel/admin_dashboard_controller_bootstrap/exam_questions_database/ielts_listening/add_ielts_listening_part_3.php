...
$total_sql = "SELECT COUNT(*) FROM ielts_listening_part_3_question";
if ($id_part_filter) {
...
$sql = "SELECT * FROM ielts_listening_part_3_question";
if ($id_part_filter) {
...
<head>
    ...
    <meta charset="UTF-8">
    <title>IELTS Listening Part 3 Questions Database</title>
...
<h1>IELTS Listening Part 3 Questions Database</h1>
...
async function openPreviewModal(idPart) {
    ...
    try {
        ...
        const response = await fetch(`http://localhost/wordpress/contents/themes/tutorstarter/template/ielts/ieltslisteningtest/database-listening-part-3/get_question_data.php?id_part=${idPart}`);
...
function openEditModal(number) {
    $.ajax({
        url: 'http://localhost/wordpress/contents/themes/tutorstarter/template/ielts/ieltslisteningtest/database-listening-part-3/get_question.php', // Fetch the question details
        type: 'POST',
        data: { number: number },
...
function saveEdit() {
    ...
    $.ajax({
        url: 'http://localhost/wordpress/contents/themes/tutorstarter/template/ielts/ieltslisteningtest/database-listening-part-3/update_question.php',
        type: 'POST',
        data: formData,
...
function saveNew() {
    ...
    $.ajax({
        url: 'http://localhost/wordpress/contents/themes/tutorstarter/template/ielts/ieltslisteningtest/database-listening-part-3/add_question.php',
        type: 'POST',
        data: formData,
        processData: false, // Required for FormData
        contentType: false, // Required for FormData
...
function deleteRecord(number) {
    if (confirm('Are you sure you want to delete this question?')) {
        $.ajax({
            url: 'http://localhost/wordpress/contents/themes/tutorstarter/template/ielts/ieltslisteningtest/database-listening-part-3/delete_question.php',
            type: 'POST',
            data: { number: number },
            success: function(response) {
