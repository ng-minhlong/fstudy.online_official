<?php
/*
 * Template Name: All Ielts Listening Results
 */
...
$total_sql = "SELECT COUNT(*) FROM save_user_result_ielts_listening";
if ($idtest_filter) {
...
$sql = "SELECT * FROM save_user_result_ielts_listening";
if ($idtest_filter) {
...
$sql2 = "SELECT * FROM ielts_listening_test_list";
...
<head>
    ...
    <meta charset="UTF-8">
    <title>All Ielts Listening Results</title>
    ...
    <?php include('../../sidebar.php'); ?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <?php include('../../topbar.php'); ?>
                ...
                <h1>All Ielts Listening Results</h1>
        ...
        if ($result_tests->num_rows > 0) {
            ...
            while ($row = $result_tests->fetch_assoc()) {
                ...
                $stats_sql = "SELECT 
                                ...
                                COUNT(*) AS test_times 
                              FROM save_user_result_ielts_listening 
...
function openEditModal(number) {
    $.ajax({
        url: 'http://localhost/wordpress/contents/themes/tutorstarter/template/admin_panel/result_admin_page/ielts_listening_results/get_result.php', // Fetch the question details
        type: 'POST',
        data: { number: number },
...
function saveEdit() {
    $.ajax({
        url: 'http://localhost/wordpress/contents/themes/tutorstarter/template/admin_panel/result_admin_page/ielts_listening_results/update_result.php',
        type: 'POST',
...
function openDetailsModal(idTest) {
    $.ajax({
        url: 'http://localhost/wordpress/contents/themes/tutorstarter/template/admin_panel/result_admin_page/ielts_listening_results/get_test_details.php',
        method: 'POST',
        data: { id_test: idTest },
        success: function(response) {
            // Đổ dữ liệu vào bảng
...
function saveNew() {
    $.ajax({
        url: 'http://localhost/wordpress/contents/themes/tutorstarter/template/admin_panel/result_admin_page/ielts_listening_results/add_result.php',
        type: 'POST',
...
function deleteRecord(number) {
    if (confirm('Are you sure you want to delete this result?')) {
        $.ajax({
            url: 'http://localhost/wordpress/contents/themes/tutorstarter/template/admin_panel/result_admin_page/ielts_listening_results/delete_result.php',
            type: 'POST',
            data: { number: number },
            success: function(response) {
