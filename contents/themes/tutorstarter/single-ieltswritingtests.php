...
$parts = explode(',', $question_choose);
                ...
                <table class="table table-striped" style="border: 1px solid #ddd; border-collapse: collapse;">
                    ...
                    foreach ($results as $result) {
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="<?php echo $site_url?>/ielts/w/result/<?php echo esc_html($result->testsavenumber); ?>">
                                    Xem bài làm
                                </a>
                            </td>
                        </tr>
    ...
    <div id="tips-container">
        <div id="full-test-content">
            ...
            <a class="btn-submit" href="<?php echo $site_url?>/test/ielts/w/<?php echo $custom_number?>/start/" >Bắt đầu bài thi</a>
        </div>
        ...
        <div id="practice-content" style="display: none;">
            ...
            <form action="<?php echo $site_url?>/test/ielts/w/<?php echo $custom_number?>/start/"  method="get">
