...
<html lang="en">
    ...
    <div class="container">
        ...
        <script>
             function pay() {
              window.location.href = "/wordpress/contents/checkout_gateway/token/vnpay_php/vnpay_pay.php";
            }
            function querydr() {
              window.location.href = "/wordpress/contents/checkout_gateway/token/vnpay_php/vnpay_querydr.php";
            }
             function refund() {
              window.location.href = "/wordpress/contents/checkout_gateway/token/vnpay_php/vnpay_refund.php";
            }
        </script>
    </body>
</html>
