                    ...
                    if ($_GET['resultCode'] == '00') {
                        ...
                        if ($transaction) {
                            if ($transaction->order_status === 'success') {
                                ...
                                $type_item = $order_item['type_item']; // Lấy loại token từ order_item
                                ...
                                if ($user_token_result) {
                                    ...
                                    // Ghi lịch sử sử dụng token (chung cho cả 2 loại)
                                    ...
                                    $token_history[] = [
                                        ...
                                        "amount" => $amount,
                                        "type" => $type_item // Thêm loại token vào lịch sử
                                    ];
