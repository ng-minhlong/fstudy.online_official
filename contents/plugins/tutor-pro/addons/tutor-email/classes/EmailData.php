	...
	public function get_recipients() {
		$email_array = array(
			...
			'email_to_teachers' => array(
				...
				'a_student_submitted_review'      => array(
					'label'         => __( 'Student Submitted a Course Review', 'tutor-pro' ),
					'default'       => 'off',
					'template'      => 'to_instructor_student_submitted_review',
					'tooltip'       => __( 'Enable to send email notification after a student submitted a course review', 'tutor-pro' ),
					'student_name'  => __( 'James Andy', 'tutor-pro' ),
					'subject'       => __( "You've Got a New Course Review!", 'tutor-pro' ),
					'heading'       => __( "You've Got a New Course Review!", 'tutor-pro' ),
					'message'       => json_encode( "<p>Good news!</p>You've just received a new review for the course: <strong>{course_name}</strong>. The review was provided by <strong>{student_name}</strong> on <strong>{submission_date}</strong>." ),
					'before_button' => __( 'Please take a moment to review the feedback and take further steps if necessary. Thank you!', 'tutor-pro' ),
					'footer_text'   => __( 'You may reply to this email to communicate with the student.', 'tutor-pro' ),
					'placeholders'  => EmailPlaceholder::only( array( 'student_username', 'course_url', 'site_url', 'site_name', 'student_name', 'user_name', 'student_email', 'submission_date' ) ),
				),
			...
			'email_to_admin'    => array(
				...
				'a_student_submitted_review' => array(
					'label'         => __( 'Student Submitted a Course Review', 'tutor-pro' ),
					'default'       => 'off',
					'template'      => 'to_admin_student_submitted_review',
					'tooltip'       => __( 'Enable to send email notification after a student submitted a course review', 'tutor-pro' ),
					'student_name'  => __( 'James Andy', 'tutor-pro' ),
					'subject'       => __( "You've Got a New Course Review!", 'tutor-pro' ),
					'heading'       => __( "You've Got a New Course Review!", 'tutor-pro' ),
