...
class ContentController extends BaseController {
	...
	public function ajax_get_lesson_details() {
		...
		if ( ! $lesson_record ) {
			$this->response_bad_request( __( 'Invalid lesson id provided' ) );
		}
	...
	public function ajax_get_assignment_details() {
		...
		if ( ! $assignment_record ) {
			$this->response_bad_request( __( 'Invalid id provided' ) );
		}
	...
	public function ajax_get_question_details() {
		...
		if ( ! $content_record ) {
			$this->response_bad_request( __( 'Invalid question id provided' ) );
		}
		...
		if ( ! $question ) {
			$this->response_bad_request( __( 'Invalid content id provided' ) );
		}
