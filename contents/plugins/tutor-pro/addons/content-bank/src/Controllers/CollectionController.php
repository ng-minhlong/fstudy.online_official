...
class CollectionController extends BaseController {
	...
	public function ajax_save_content_bank_collection() {
		...
		if ( Input::has( 'id' ) ) {
			...
			$this->collection_model->create( array( 'post_title' => $name ) );
			$response_message = __( 'Collection created successfully', 'tutor-pro' );
		}

		return $this->json_response( $response_message );
	}
	...
	public function ajax_duplicate_collection() {
		...
		$this->json_response( __( 'Collection successfully duplicated', 'tutor-pro' ) );
	}
}
