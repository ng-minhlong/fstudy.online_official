...
function tino_momo_init_gateway_class()
{
    class WC_Tino_Momo_Gateway extends WC_Payment_Gateway
    {
        public function __construct()
        {
            ...
            $this->method_description = 'Thiết lập thanh toán đơn hàng qua cổng thanh toán momo'; // will be displayed on the options page
        ...
        {
            $icon_html = '<img style="max-height: 35px;" src="' . plugins_url('assets/img/logo-momo.svg', __FILE__) . '" alt="' . esc_attr__('Momo acceptance mark', 'woocommerce') . '" />';
