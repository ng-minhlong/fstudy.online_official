        ...
        item.addEventListener('click', function () {
            ...
            if (selectedPaymentMethod === 'momo' || selectedPaymentMethod === 'bidv') {
				if (selectedPaymentMethod === 'momo' ){
					qrCodeUrl = '<?php echo site_url(); ?>/contents/uploads/2025/02/momo_qr.jpg'; // Sửa dấu "==" thành "="
				}
				else if (selectedPaymentMethod === 'bidv' ){
					qrCodeUrl = '<?php echo site_url(); ?>/contents/uploads/2025/02/bidv_qr.jpg'; // Sửa dấu "==" thành "="
				}
