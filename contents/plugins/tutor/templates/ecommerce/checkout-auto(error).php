								...
								//	foreach ( $supported_gateways as $gateway ) {
									//	list( 'is_manual' => $is_manual, 'name' => $name, 'label' => $label, 'icon' => $icon) = $gateway;
										...
										<label class="tutor-checkout-payment-item" data-payment-type="automate">
											<input type="radio" name="payment_method" value="momo" class="tutor-form-check-input" required>
											<div class="tutor-payment-item-content">
										<img class="icon-payment" src="<?php echo site_url(); ?>/contents/uploads/2025/02/MoMo_Logo.png" alt="Momo Auto Payment" />
												<p> Momo Auto</p>
											</div>

										</label>
										<label  class="tutor-checkout-payment-item" data-payment-type="automate">
											<input type="radio" name="payment_method" value="vnpay" class="tutor-form-check-input" required>
											<div class="tutor-payment-item-content">
												<img class = "icon-payment"   src = "<?php echo site_url(); ?>/contents/uploads/2025/02/VNPay_Logo.jpg" alt="VNPAY Auto Payment"/>
												<p> VNPay Auto</p>
											</div>
        ...
        item.addEventListener('change', function () {
            ...
            if (selectedPaymentMethod === 'momo' || selectedPaymentMethod === 'bidv') {
				if (selectedPaymentMethod === 'momo' ){
					qrCodeUrl = 'http://localhost/wordpress/contents/uploads/2025/02/momo_qr.jpg'; // Sửa dấu "==" thành "="
				}
				else if (selectedPaymentMethod === 'bidv' ){
					qrCodeUrl = 'http://localhost/wordpress/contents/uploads/2025/02/bidv_qr.jpg'; // Sửa dấu "==" thành "="
				}
                ...
                Swal.fire({
                    ...
                    html: `
                        ...
                        <p><strong>Nội dung chuyển khoản:</strong> ${details}</p>
